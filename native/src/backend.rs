...
const BACKEND_NAME: &str = "dj-media-hub-backend.exe";
const BACKEND_PORT: u16 = 11180;
const BACKEND_TAG: &str = "dj-media-hub-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "DJ_MEDIA_HUB_PORT";
const ENV_HOST: &str = "DJ_MEDIA_HUB_HOST";
const ENV_TAURI: &str = "DJ_MEDIA_HUB_TAURI";
